...
import com.zizzle.socketio.handler.SuccessAuthorizationListener;
import com.zizzle.socketio.listener.DefaultExceptionListener;
import com.zizzle.socketio.listener.ExceptionListener;
import com.zizzle.socketio.protocol.JsonSupport;
import com.zizzle.socketio.store.MemoryStoreFactory;
import com.zizzle.socketio.store.RedissonStoreFactory;
import com.zizzle.socketio.store.StoreFactory;
import com.zizzle.socketio.store.HazelcastStoreFactory;
    ...
    Configuration(Configuration conf) {
        ...
        if (conf.getJsonSupport() == null) {
            try {
                ...
                try {
                    Class<?> jjs = getClass().getClassLoader().loadClass("com.zizzle.socketio.protocol.JacksonJsonSupport");
