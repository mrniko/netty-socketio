...
public interface AuthTokenListener {
  ...
  /**
   * Socket.IO clients from version 4 can offer an auth token when connecting to a namespace. This
   * listener gets invoked if a token is found in the connect packet
   *
