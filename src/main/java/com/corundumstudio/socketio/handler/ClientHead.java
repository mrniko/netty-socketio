...
public class ClientHead {
  ...
  public void schedulePingTimeout() {
    ...
    scheduler.schedule(
        ...
        configuration.getPingTimeout() + configuration.getPingInterval(),
        TimeUnit.MILLISECONDS);
  }
  ...
  /**
   * Returns true if and only if the I/O thread will perform the requested write operation
   * immediately. Any write requests made when this method returns false are queued until the I/O
