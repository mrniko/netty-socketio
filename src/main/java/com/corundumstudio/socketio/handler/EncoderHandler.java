...
public class EncoderHandler extends ChannelOutboundHandlerAdapter {
  ...
  private void sendError(
      HttpErrorMessage errorMsg, ChannelHandlerContext ctx, ChannelPromise promise)
      throws IOException {
  ...
  /**
   * Helper class for the handleWebsocket method, handles a list of ChannelFutures and sets the
   * status of a promise when - any of the operations fail - all of the operations succeed The
   * setChannelPromise method should be called after all the futures are added
   */
