 ...
 *
 * <p>Notifies about acknowledgement received from client via {@link #onSuccess} callback method.
 *
 * <p>By default it may wait acknowledgement from client while {@link SocketIOClient} is alive.
 * Timeout can be defined {@link #timeout} as constructor argument.
 *
 * <p>This object is NOT actual anymore if {@link #onSuccess} or {@link #onTimeout} was executed.
 *
