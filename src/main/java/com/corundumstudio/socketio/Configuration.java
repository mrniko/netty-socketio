...
import com.corundumstudio.socketio.handler.DefaultSessionIDFactory;
...
public class Configuration {
    ...
    private List<Transport> transports = Arrays.asList(Transport.WEBSOCKET,
            Transport.POLLING);
    ...
    private SessionIDFactory sessionIDFactory = new DefaultSessionIDFactory();
    ...
    Configuration(Configuration conf) {
        ...
        setTransports(conf.getTransports().toArray(
                new Transport[conf.getTransports().size()]));
    ...
    /**
     * Allows to setup custom implementation of JSON
    ...
    /**
     * Data store - used to store session data and implements distributed
     * pubsub. Default is {@code MemoryStoreFactory}
     * 
     * @param storeFactory
    ...
    /**
     * Authorization listener invoked on every handshake. Accepts or denies a
     * client by {@code AuthorizationListener.isAuthorized} method.
     * <b>Accepts</b> all clients by default.
     * 
     * @param authorizationListener
     *            - authorization listener itself
     * 
    ...
    /**
     * Session ID factory used to generated a new ID or parse a one from URL,
     * or cookie.
     * 
