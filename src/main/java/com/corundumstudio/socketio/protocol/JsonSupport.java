...
/**
 * JSON infrastructure interface. Allows to implement custom realizations to JSON support
 * operations.
 */
public interface JsonSupport {
  ...
  <T> T readValue(String namespaceName, ByteBufInputStream src, Class<T> valueType)
      throws IOException;
