...
public interface ClientListeners {
  ...
  void addMultiTypeEventListener(
  ...
  /**
   * from v4, ping will always be sent by server except probe ping packet sent from client, and pong
   * will always be responded by client while receiving ping except probe pong packet responded from
   * server it makes no more sense to listen to ping packet, instead you can listen to pong packet
   *
