...
public class WebSocketTransport extends ChannelInboundHandlerAdapter {
  ...
  public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
    if (msg instanceof CloseWebSocketFrame) {
      ...
      ctx.pipeline()
          .fireChannelRead(new PacketsMessage(client, frame.content(), Transport.WEBSOCKET));
      frame.release();
  ...
  public void channelInactive(ChannelHandlerContext ctx) throws Exception {
    ...
    Packet packet =
        new Packet(
            PacketType.MESSAGE,
            client != null ? client.getEngineIOVersion() : EngineIOVersion.UNKNOWN);
  ...
  private void handshake(
    ...
    WebSocketServerHandshakerFactory factory =
        new WebSocketServerHandshakerFactory(
            getWebSocketLocation(req), null, true, configuration.getMaxFramePayloadLength());
