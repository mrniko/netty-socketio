...
/**
 * Ack request received from Socket.IO client. You can always check is it <code>true</code> through
 * {@link #isAckRequested()} method.
 *
 * <p>You can call {@link #sendAckData} methods only during {@link DataListener#onData} invocation.
 * If {@link #sendAckData} not called it will be invoked with empty arguments right after {@link
 * DataListener#onData} method execution by server.
 *
 * <p>This object is NOT actual anymore if {@link #sendAckData} was executed or {@link
 * DataListener#onData} invocation finished.
 */
public class AckRequest {
  ...
  /**
   * Send ack data to client. Can be invoked only once during {@link DataListener#onData} method
   * invocation.
   *
