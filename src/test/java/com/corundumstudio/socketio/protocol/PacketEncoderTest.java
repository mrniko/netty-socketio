...
/**
 * Comprehensive test suite for PacketEncoder class Tests all packet types and encoding formats
...
public class PacketEncoderTest extends BaseProtocolTest {
  ...
  @Mock private ByteBufAllocator allocator;
  ...
  public void testProcessUtf8() throws Exception {
    ...
    Method processUtf8Method =
        PacketEncoder.class.getDeclaredMethod(
            "processUtf8", ByteBuf.class, ByteBuf.class, boolean.class);
  ...
  public void testEncodePerformance() throws IOException {
    ...
    assertTrue(
        (endTime - startTime) < 100, "Encoding took too long: " + (endTime - startTime) + "ms");
