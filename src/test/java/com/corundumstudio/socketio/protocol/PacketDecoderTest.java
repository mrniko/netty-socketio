...
/**
 * Comprehensive test suite for PacketDecoder class Tests all packet types and encoding formats
 * according to Socket.IO V4 protocol
 */
public class PacketDecoderTest extends BaseProtocolTest {
  ...
  public void testDecodeConnectPacketWithAuthData() throws IOException {
    ...
    when(jsonSupport.readValue(eq("/admin"), any(), eq(Map.class))).thenReturn(authData);
  ...
  public void testDecodeEventPacketWithNamespace() throws IOException {
    ...
    ByteBuf buffer =
        Unpooled.copiedBuffer("42/admin,456[\"project:delete\",123]", CharsetUtil.UTF_8);
  ...
  public void testDecodeAckPacket() throws IOException {
    ...
    // Mock ack manager
    when(ackManager.getCallback(any(), eq(456L))).thenReturn((AckCallback) ackCallback);
  ...
  public void testDecodeAckPacketWithoutCallback() throws IOException {
    ...
    when(ackManager.getCallback(any(), eq(456L))).thenReturn(null);
  ...
  public void testDecodeBinaryEventPacket() throws IOException {
    // BINARY_EVENT packet: "45-[\"hello\",{\"_placeholder\":true,\"num\":0}]" (MESSAGE +
    // BINARY_EVENT)
    ByteBuf buffer =
        Unpooled.copiedBuffer(
            "45-[\"hello\",{\"_placeholder\":true,\"num\":0}]", CharsetUtil.UTF_8);
  ...
  public void testDecodeBinaryEventPacketWithNamespace() throws IOException {
    // BINARY_EVENT packet with namespace:
    // "45-/admin,456[\"project:delete\",{\"_placeholder\":true,\"num\":0}]" (MESSAGE +
    // BINARY_EVENT)
    ByteBuf buffer =
        Unpooled.copiedBuffer(
            "45-/admin,456[\"project:delete\",{\"_placeholder\":true,\"num\":0}]",
            CharsetUtil.UTF_8);
  ...
  public void testDecodeBinaryAckPacket() throws IOException {
    ...
    ByteBuf buffer =
        Unpooled.copiedBuffer(
            "46-/admin,456[\"response\",{\"_placeholder\":true,\"num\":0}]", CharsetUtil.UTF_8);
  ...
  public void testDecodeMultiplePackets() throws IOException {
    // Multiple packets separated by 0x1E: "40/admin,0x1E42[\"hello\"]" (MESSAGE + CONNECT, MESSAGE
    // + EVENT)
  ...
  public void testReadLong() throws Exception {
    ...
    Method readLongMethod =
        PacketDecoder.class.getDeclaredMethod("readLong", ByteBuf.class, int.class);
  ...
  public void testReadInnerType() throws Exception {
    ...
    // Use reflection to test private method
    Method readInnerTypeMethod =
        PacketDecoder.class.getDeclaredMethod("readInnerType", ByteBuf.class);
  ...
  public void testHasLengthHeader() throws Exception {
    ...
    // Use reflection to test private method
    Method hasLengthHeaderMethod =
        PacketDecoder.class.getDeclaredMethod("hasLengthHeader", ByteBuf.class);
  ...
  public void testDecodePerformance() throws IOException {
    ...
    assertTrue(
        (endTime - startTime) < 100, "Decoding took too long: " + (endTime - startTime) + "ms");
