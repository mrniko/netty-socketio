...
public abstract class StoreFactoryTest {
  ...
  @Mock protected NamespacesHub namespacesHub;

  @Mock protected AuthorizeHandler authorizeHandler;

  @Mock protected JsonSupport jsonSupport;
  ...
  public void testCreatePubSubStore() {
    ...
    assertTrue(
        pubSubStore instanceof PubSubStore, "PubSubStore should implement PubSubStore interface");
  }
